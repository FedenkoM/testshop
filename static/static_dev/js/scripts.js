$(document).ready(function(){
    ...
    //});
     ...
     // $(document).on('click', '.delete-item', function(e){ <!--видалення товару із корзини-->
     //     e.preventDefault();
    ...
    // функція для виводу загальної вартості замовлення
    ...
    //функція для зміни кількості товару та відповідно заг.вартості на сторінці
